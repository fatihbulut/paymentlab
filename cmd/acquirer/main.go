...
import (
	...
	"paymentlab/internal/acquirer"
	"paymentlab/internal/config"
	"paymentlab/internal/iso"
	"paymentlab/internal/otel"
	"paymentlab/internal/store"
	storepostgres "paymentlab/internal/store/postgres"
)
